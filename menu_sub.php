				 ...
				 <div  class="col-sm-12 ">
					<header>
						<?
						 ...
						 $sql = "SELECT a.product_type_title_th,a.product_category_title_th,a.product_code ,a.product_title_th ,a.product_description_th 
						 ,(SELECT image FROM product_image WHERE a.product_code = product_code ORDER BY INSERT_DATE ASC LIMIT 1 ) AS image_product  
						 FROM product_main a    WHERE  a.product_type_code = '$id_menu' AND a.sell_with_web = '1' ORDER BY a.INSERT_DATE DESC limit 1";
						...
						<h1><?php echo $result['product_type_title_th']; ?></h1>
				 ...
				 <div  class="col-sm-12 text-center">
					<ul class="product-list row">
						...
						<?
						 ...
						 $sql = "SELECT a.product_type_title_th,a.product_category_title_th,a.product_code ,a.product_title_th ,a.product_description_th 
						 ,(SELECT image FROM product_image WHERE a.product_code = product_code ORDER BY INSERT_DATE ASC LIMIT 1 ) AS image_product  
						 FROM product_main a    WHERE  a.product_type_code = '$id_menu' AND a.sell_with_web = '1' ORDER BY a.INSERT_DATE DESC ";
							 $query = mysqli_query($conn, $sql);
