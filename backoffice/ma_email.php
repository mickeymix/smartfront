            ...
            <div id="page-inner">
				...
				<form class="card card-sm" name="myForm" action="ma_email.php" onsubmit="return validateForm()">
					<div class="col-12 col-md-12 col-lg-3" style=" padding-right: 0px;">		
						<input class="form-control form-control-lg form-control-borderless" id="emailcs" name="keyword" value="<?php echo $_GET['keyword'];?>" type="search" placeholder="ค้นหา Email">
					...
					<div class="col-12 col-md-12 col-lg-2" style=" padding-right: 0px;">
							...
							<div class="input-group" >
								...
								<input type="text"name="start_date" id="datepicker"  value="<?php echo $_GET['start_date'];?>"  placeholder="เริ่ม" />
					...
					<div class="col-12 col-md-12 col-lg-2" style=" padding-right: 0px;">
							...
							<div class="input-group" >
								...
								<input type="text"name="end_date" id="datepicker2"  value="<?php echo $_GET['end_date'];?>"  placeholder="สิ้นสุด" />
								<label class=" " for="date" style="background-color: #cbcdd1;" >
...
?>								
                                        <tr>
											...
											<button class="btn btn-danger" onClick="javascript:location.href='ma_email.php?action=998&id=<?php echo $result['id_email']; ?>'"><i class="fa fa-pencil"></i>ลบ</button>
											</td>
		 ...
		 <li>
			 <a href="ma_email.php?page=1" aria-label="Previous">
				 <span aria-hidden="true">&laquo;</span>
					 ...
					 if($i == $page){
					?>	 
						<li class='active'><a  href="ma_email.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?	
					}else{
					?>
