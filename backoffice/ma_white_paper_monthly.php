...
if ($_FILES["filUpload"]["name"]<>''){
    if(move_uploaded_file($_FILES["filUpload"]["tmp_name"],$_SERVER['DOCUMENT_ROOT']."/white_paper/".$_FILES["filUpload"]["name"])) {
        ...
        $sql = "UPDATE white_paper_master SET paper_name = '".$paper_name."',paper_email_template = '".$paper_email_template."',paper_link = '".$_FILES["filUpload"]["name"]."',
        update_datetime =SYSDATE() ,update_user = '".$_SESSION["username_log"]."' WHERE paper_id = 3";
    ...
    $sql = "UPDATE white_paper_master SET paper_name = '".$paper_name."',paper_email_template = '".$paper_email_template."',
        update_datetime =SYSDATE() ,update_user = '".$_SESSION["username_log"]."' WHERE paper_id = 3";
...
?>
    ...
    <div id="wrapper">
        ...
        <form id="myform" action="ma_white_paper_monthly.php" method="POST" class="form-horizontal"
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    ...
                    <input class="form-control" placeholder="" type="text" name="paper_name" value="<?echo $result['paper_name']?>"/>
                    <br>


                    <label>EmailMessage</label>

                    <div class="summernote1"><?= $row["paper_email_template"]; ?></div>
