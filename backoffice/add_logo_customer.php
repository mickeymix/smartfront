...
if ($_POST["action"] == "1") {
    ...
    $sql = "INSERT INTO customer_logo_page  
	       (image_logo,linktestimo)
	VALUES ('$target_file','$name_button')";
...
<div id="wrapper">
    ...
    <form action="add_logo_customer.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>จัดการภาพLOGO ของ Customer</h2>
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
