    ...
    'imageAttributes': function (context) {
      ...
      this.initialize = function () {
        ...
        body +=    '</ul>' +
                   ...
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-class">' +
                   ...
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-style">' +
                   ...
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-role">' +
                   ...
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-link-href">' +
                   ...
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-link-target">' +
                   ...
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-link-class">' +
                   ...
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-link-style">' +
                   ...
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-link-rel">' +
                   ...
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-link-role">' +
      ...
      if (options.imageAttributes.disableUpload == false) {
        ...
        body +=    '  <div class="tab-pane note-tab-pane fade in active" id="note-imageAttributes' + timestamp + '">' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-url">' +
...
//                   '        </span>' +
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-title">' +
                   ...
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-alt">' +
                   ...
                   '      </div>' +
                   '    </div>' +
                   '    <div class="note-form-group2 form-group2 note-group-imageAttributes-dimensions">' +
