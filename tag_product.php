			 ...
			 <nav>
				 ...
				 <ul class="pagination">
					 ...
					 <li>
						 ...
						 <a href="tag_product.php?page=1&keyword=<? echo $_GET["keyword"]; ?>" aria-label="Previous">
							 ...
							 <span aria-hidden="true">&laquo;</span>
								...
								?>	 
									...
									<li class='active'><a  href="tag_product.php?page=<?php echo $i; ?>&keyword=<? echo $_GET["keyword"]; ?>"><?php echo $i; ?></a></li>
								...
								?>
									...
									<li><a href="tag_product.php?page=<?php echo $i; ?>&keyword=<? echo $_GET["keyword"]; ?>"><?php echo $i; ?></a></li>
						 ...
						 <a href="tag_product.php?page=<?php echo $total_page;?>&keyword=<? echo $_GET["keyword"]; ?>" aria-label="Next">
