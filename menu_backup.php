 ...
 <ul class="nav navbar-nav" id="header-nav-left">
	<li class="dropdown" id="header-nav-categories">
		...
		<a id="TopNavToggleDropDownLink" href="#" class="dropdown-toggle dropdown-toggle-darkblue" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span>All Products <span id="nav-status-indicator" class="glyphicon glyphicon-chevron-down"></span></a>
		<ul class="dropdown-menu">
			...
			<li class="dropdown-submenu">
				<a target="_blank" href="menu_main.php?id_menu=<?php echo $id_menu; ?>&menu_keyword=<?php echo $result['menu_keyword']; ?>"   >
					<img src="backoffice/<?php echo $result['menu_img']; ?>" width="32px" >
				 ...
				 ?>	
					<li >
						...
						<a target="_blank" href="<?php echo $result2['url_menu']; ?>">
							<img src="backoffice/<?php echo $result2['sub_menu_img']; ?>" width="32px" >
							<?php echo $result2['name_sub_menu']; ?>
						</a>
					</li>
				 <? } ?>
				  </ul>
