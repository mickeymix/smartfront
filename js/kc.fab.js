    ...
    $.kc.fab = function(el, links, options){
        ...
        base.init = function(){
            ...
            if (base.links.length > 0){
                ...
                bg_color_style = ":#d90607";
                main_btn_dom = "<button data-link-href='"+((main_btn.url)?main_btn.url:"")+"' data-link-target='"+((main_btn.target)?main_btn.target:"")+"' class='kc_fab_main_btn' style='"+bg_color_style+"'><img src='images/logotf.png' width='20px height='20px' padding-right='22px''/><span style='"+color_style+"'>"+main_btn.text_menu+"</span></button>";
               
                // main_btn_dom = "<img src='/images/logo_footer_new.png'  alt='HTML5 Icon' style='width:128px;height:128px;'>";
                ...
                for (var i = 0; i < base.links.length; i++) {
                    ...
                    sub_fab_btns_dom += "<div><button data-link-title='"+base.links[i].title+"' data-link-href='"+(base.links[i].url?base.links[i].url:"")+"' data-link-target='"+((base.links[i].target)?base.links[i].target:"")+"' class='sub_fab_btn' style='"+bg_color_style+"'><img src='"+base.links[i].icon+"'width='200px height='200px' padding-right='22px''/></button></div>";
