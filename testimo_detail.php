...
while ($result = mysqli_fetch_assoc($query)) { ?>
    ...
    <meta property="og:description" content="<?php echo $result['short_description_testimo']; ?>"/>
    ...
    <meta name="twitter:description" content="<?php echo $result['short_description_testimo']; ?>">
                ...
                while ($result = mysqli_fetch_assoc($query)) {
                    ...
                    <div class="col-sm-8 ">
                        <div align="right" style="height:50px">
                            ...
                            ?>
                            <a target="_blank"
                               href="http://www.facebook.com/sharer.php?u=<?php echo urlencode($urlForShare) ?>"><img
                                        src="images/fb_share.png" width="40px"></a>
                            <a target="_blank"
                               href="https://twitter.com/intent/tweet?url=<?php echo urlencode($urlForShare) ?>"><img
