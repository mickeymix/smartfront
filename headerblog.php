...
<div id="site-wrapper" class="site-wrapper container">
    <!--[if lt IE 9]>
			<p class="browsehappy"><strong>WARNING:</strong> You are using an <strong>outdated</strong> browser. Please <b><a href="http://browsehappy.com/">upgrade your browser</a></b> to improve your experience.</p>
			<![endif]-->
        ...
        <div class="navbar-top row dont-print">
            <nav class="site-navigation">
                ...
                <ul class="header-links list-inline">
                    ...
                    <li id="headerNavTaxLink"><a target="_blank" href="/service_menu.php?common_smart_id=107">ทำไมต้องเรา?</a></li>
                    <li id="headerNavAboutLink"><a target="_blank"  href="/service_menu.php?common_smart_id=108">ติดต่อเรา</a></li>
                    <li id="headerNavContactLink"><a href="#">ใบเสนอราคา</a></li>
                    <li id="headerNavContactLink"><a href="#">เปลี่ยนภาษา</a></li>
                </ul>
            </nav>
        </div>
        <div class="brandingBlog row dont-print">
            ...
            <a href="index.php">
            <p class="font-logo">
                <font class="font-logo" color="white">ร้านไทยจราจร</font></a>
            </p>
                    ...
                    <div id="search-bar" class="search-bar dont-print">
                        <div class="search col-sm-4 col-lg-6">
                            <div class="search-group input-group">
                                <input class="search-field form-control" type="text" id="search-term" placeholder="Search for cones, bumps, signs, etc...">
                                <img class="search-icon dont-print cld-responsive" src="https://media.trafficsafetystore.com/image/upload/c_limit,dpr_3.0,q_auto:best,w_auto/v47/images/search-icon.png" data-src="https://media.trafficsafetystore.com/image/upload/c_limit,dpr_3.0,q_auto:best,w_auto/v47/images/search-icon.png" alt="Search Icon">
...
<!--                                    <a href="javascript:DoSearch('/search');" class="btn btn-dark" type="button">Go</a>-->
                            ...
                            <?php if (isset($_SESSION['customer_id']) && !empty($_SESSION['customer_id'])) {   ?>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content">
                                        <li class="store-cart">
                                            <a href="index.php?action=logout"><span class="glyphicon glyphicon-log-out" style="color:black"></span>
                            ...
                            <? } else { ?>
                                <? if (isset($_SESSION['facebook_id']) && !empty($_SESSION['facebook_id'])) { ?>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-content">
                                            <li class="store-cart">
                                                <a href="index.php?action=logoutfacebook"><span class="glyphicon glyphicon-log-out" style="color:black"></span>
                                ...
                                <? } else { ?>
                                    <li class="store-user"><a href="login.php">Login</a> <i>/</i> <a href="register.php">Register</a></li>
                                <? } ?>
                            <? } ?>
                            <li class="store-cart"><a href="#"><img class="cart-icon" src="https://media.trafficsafetystore.com/image/upload/c_limit,dpr_2.0,f_auto,q_auto:best,w_auto/v1/images/cart-icon-2x.png"></a></li>&nbsp;&nbsp;
                            <li class="order-cart"><a href="#"><img class="cart-icon" src="images/order_form.png" width="30px"></a></li> &nbsp;&nbsp;
                            <li class="lineAds"><a target="_blank" href="http://line.me/ti/p/@trafficthai"><img class="cart-icon" src="images/lineAt_icon.png" width="30px"></a></li>&nbsp;&nbsp;&nbsp;

                            <li class="facebookAds"><a target="_blank" href="https://www.facebook.com/trafficthai/"><img src="images/page_facebook.png" width="30px"></a></li>&nbsp;&nbsp;
    ...
    <header class="print-only printAtFullWidth">
        <img src="images\tss_Logo_blue.png" style="max-height: 30px; vertical-align: middle;" alt="Traffic Safety Store Logo">
        <span class="pull-right" style="text-align:right; font-size:16px; font-weight:600;"><span class="glyphicon glyphicon-link glyphicon-position-static"></span> www.test.com&nbsp; <span class="glyphicon glyphicon-earphone glyphicon-position-static"></span> 02-111-5555</span>
    </header>
        ...
        <div class="col-xs-4 text-center no-pad dont-print" id="mobile-logo">
            <div style="display: table-cell; vertical-align: middle; height: 45px;">
                <a href="index.php" class="logo-mobile">
                    <img class="cld-responsive" src="images/logotf.png" alt="Traffic Safety Store Home" style="max-height: 30px; vertical-align: middle; ">
                    ร้านไทยจราจร
                </a>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WKBNDBC"
